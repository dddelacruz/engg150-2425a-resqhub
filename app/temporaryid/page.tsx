  ...
  return (
    <div>
      ...
      <div className="max-w-4xl mx-auto">
        <form onSubmit={handleSubmit} className="max-w-md mx-auto p-4 border bg-card text-card-foreground shadow rounded-xl">
          <div className='my-4 text-start'>
            <label htmlFor='tempId' className='ext-2m font-bold'>
              Temporary ID
            </label>
            <input type="text" id="tempId" name="tempId" 
                className="w-full px-3 py-2 mb-3 border rounded-lg focus:outline-none focus:border-blue-500" disabled
                value={tempId}
            ...
            <input type="date" id="birthdate" name="birthdate" 
                className="w-full px-3 py-2 mb-3 border rounded-lg rounded-lg focus:outline-none focus:border-blue-500"
                value={birthdate}
            ...
            <div className="text-end">
              <button type="submit" className="mt-5 bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded-lg" >Submit</button>
            </div>
          </div>
        </form>
      </div>
